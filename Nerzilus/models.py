...
class Tenant(database.Model):
    ...
    logo_image = database.Column(database.String(255), nullable=True)
    logo_image_data = database.Column(database.LargeBinary, nullable=True)
    logo_image_mimetype = database.Column(database.String(120), nullable=True)
